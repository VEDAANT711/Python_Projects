...
button_9 = tk.Button(master=frame, text=2, padx=15,
...
button_substract = tk.Button(master=frame, text="-", padx=15,
                         pady=5, width=3,command=lambda: myclick('-'))
...
button_back = tk.Button(master=frame, text="Back", padx=15,
                         pady=5, width=9, command=backspace)
button_back.grid(row=7, column=0, columnspan=2, pady=2)
